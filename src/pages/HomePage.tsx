...
const HomePage: React.FC = () => {
  ...
  const filteredProducts = useMemo(() => {
    return products.filter(product => {
      ...
      const matchesPackaging = selectedPackaging.length === 0 || selectedPackaging.includes(product.packaging);
      const matchesUnit = selectedUnits.length === 0 || selectedUnits.includes(product.unit);

      return matchesSearch && matchesCategory && matchesBrand && matchesVolume && matchesPackaging && matchesUnit;
    });
  }, [searchQuery, selectedCategory, selectedBrands, selectedVolumes, selectedPackaging, selectedUnits]);
  ...
  const availableBrands = selectedCategory ? brands[selectedCategory as keyof typeof brands] || [] : [];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="sticky top-0 bg-white border-b border-primary-100 px-6 py-4 z-10">
        <div className="mb-4">
          ...
          <p className="text-primary-600">What would you like to order today?</p>
        </div>
        ...
        <div className="relative mb-4">
          ...
          <button
            ...
            className={`absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-lg transition-colors ${
              showFilters ? 'bg-primary-950 text-white' : 'text-primary-400 hover:bg-primary-100'
            }`}
          >
        ...
        {showFilters && (
          ...
          >
            {/* Category Filter */}
            <div>
              <h3 className="text-sm font-medium text-primary-700 mb-2">Category</h3>
            ...
            {availableBrands.length > 0 && (
              <div>
                <h3 className="text-sm font-medium text-primary-700 mb-2">Brand</h3>
                <div className="flex gap-2 overflow-x-auto pb-2">
            ...
            {/* Volume Filter */}
            <div>
              <h3 className="text-sm font-medium text-primary-700 mb-2">Volume</h3>
              <div className="flex gap-2 overflow-x-auto pb-2">
                {volumes.map(volume => (
                  <button
                    key={volume}
      ...
      <div className="px-6 py-6">
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-primary-950 mb-2">No products found</h3>
