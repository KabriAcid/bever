...
const CartPage: React.FC = () => {
  ...
  const { getCartItemsWithDetails, updateQuantity, removeItem, getTotalPrice, getTotalItems } = useCart();
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="flex flex-col items-center justify-center px-6 py-20">
          ...
          <h2 className="text-2xl font-bold text-primary-950 mb-2">Your cart is empty</h2>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-primary-200 px-6 py-4">
        <div className="space-y-3 mb-4">
          ...
          {deliveryFee === 0 && (
            <p className="text-xs text-accent-600">Free delivery on orders above ₦5,000</p>
          )}
