...
import { ShoppingCart, Users, DollarSign, Star, TrendingUp, Package } from 'lucide-react';
...
export function Dashboard() {
  ...
  const kpis = [
    ...
    { label: 'Active Users', value: activeUsers, change: 8.2, icon: Users },
    { label: 'Total Orders', value: totalOrders, change: -3.1, icon: ShoppingCart },
    { label: 'Avg Rating', value: avgRating.toFixed(1), change: 5.4, icon: Star },
  ];
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-0.5">
                    {transaction.id} • {transaction.items} items • {transaction.orderDate}
                  </p>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-semibold text-gray-900 digit">₦{transaction.amount.toLocaleString()}</span>
                </div>
              </div>
            ))}
          </div>
