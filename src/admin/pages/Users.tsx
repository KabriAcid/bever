  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <Table
          headers={['Business', 'Owner', 'Contact', 'Status', 'Account', 'Orders', 'Total Spent', 'Actions']}
          loading={loading}
        >
          {filteredUsers.map((user) => (
            <TableRow key={user.id}>
              ...
              <TableCell>
                <span className="digit font-medium">₦{user.totalSpent.toLocaleString()}</span>
              </TableCell>
              <TableCell>
                <div className="flex items-center gap-2">
                  ...
                  <button
                    className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors"
                    title={user.userStatus === 'active' ? 'Suspend User' : 'Activate User'}
                  >
